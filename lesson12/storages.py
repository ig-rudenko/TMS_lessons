from lesson12.abstract_storage import AbstractStorage
from lesson12.data_structures import Person


# Импорт идет от корня проекта
...
st = InMemoryStorage()
fs = FileStorage("storage.txt")

p = Person("<NAME>", "apssw")

PersonStorage(p, fs).save_user_data()
